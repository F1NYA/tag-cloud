from flask_app.app.utils import get_file, parse_user, parse_users
from flask_app.app.messages_processor.tag_cloud import get_cloud
from werkzeug.contrib.cache import SimpleCache
from flask import Flask, Response, redirect
from flask_pymongo import PyMongo
from flask_app.app.settings import MONGO_URI
...
def get_pagination_information():
    ...
    return app.response_class(
        response=json.dumps(pages_number, ensure_ascii=False),
        status=200,
        mimetype='application/json'
    )
